  ...
  return (
    ...
    <div className={`${showValue? 'w-full' : 'w-0'} popUp `}>
            ...
            <div className={`${showValue? 'block' : 'hidden'} inputFild`} >
                ...
                <h2>Title</h2>
                <input onChange={(e)=>setTododata((prev)=>({...prev , todoTitle:e.target.value}))} type="text" placeholder='Title...' /> 
                <h2 className='Note'>Note</h2>
                <textarea onChange={(e)=>setTododata((prev)=>({...prev , todoNote:e.target.value}))} className='Notetext' type="text" placeholder='Note......' />
                {/* -------------------------colors--------------------------------- */}
